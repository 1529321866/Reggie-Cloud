...
public class ShoppingCartServiceImpl implements ShoppingCartService {
    ...
    // check 默认true 检查远程服务是否启动
    // check = false不检查远程服务是否启动
    @DubboReference(check = false,cluster = "failback", interfaceClass = ProductDubboService.class,
            interfaceName = "top.starshine.dubbo.ProductDubboService", version = "1.0.0")
